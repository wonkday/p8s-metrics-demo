...
#### main use of this project is as a runtime ms that can generate p8s metrics and this info will be used in another project "SRE-Agent"(https://github.com/wonkday/sre-agent) which will use Langchain/Langgraph and LLM, mcp server and p8s client to interact with p8s. 
